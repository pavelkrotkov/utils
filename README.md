...
- PDF to Markdown conversion (Mathpix API, PyMuPDF4LLM, or local marker).
...
```bash
pip install mpxpy marker-pdf pymupdf4llm requests torch pyannote.audio beautifulsoup4 lxml numpy pandas
```
